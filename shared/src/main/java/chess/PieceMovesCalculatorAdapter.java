...
public class PieceMovesCalculatorAdapter implements JsonDeserializer<PieceMovesCalculator> {
    public PieceMovesCalculator deserialize(JsonElement el, Type type, JsonDeserializationContext ctx) throws JsonParseException {
